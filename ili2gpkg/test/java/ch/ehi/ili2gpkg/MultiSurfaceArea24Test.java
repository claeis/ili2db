...
public class MultiSurfaceArea24Test extends ch.ehi.ili2db.MultiSurfaceArea24Test {
    ...
    protected void assertMultiSurfaceArea24_classa12_geomattr(Statement stmt) throws Exception {
        ...
        while (rs.next()) {
            assertEquals("MULTISURFACE {surface [SURFACE {boundary [BOUNDARY {polyline POLYLINE {sequence SEGMENTS {segment [COORD {C1 480000.111, C2 70000.111, C3 5000.111}, COORD {C1 480000.222, C2 70000.222, C3 5000.222}, COORD {C1 480000.333, C2 70000.333, C3 5000.333}]}}}, BOUNDARY {polyline POLYLINE {sequence SEGMENTS {segment [COORD {C1 480000.444, C2 70000.444, C3 5000.444}, COORD {C1 480000.555, C2 70000.555, C3 5000.555}, COORD {C1 480000.666, C2 70000.666, C3 5000.666}]}}}]}, SURFACE {boundary [BOUNDARY {polyline POLYLINE {sequence SEGMENTS {segment [COORD {C1 480000.111, C2 70000.111, C3 5000.111}, COORD {C1 480000.222, C2 70000.222, C3 5000.222}, COORD {C1 480000.333, C2 70000.333, C3 5000.333}]}}}, BOUNDARY {polyline POLYLINE {sequence SEGMENTS {segment [COORD {C1 480000.444, C2 70000.444, C3 5000.444}, COORD {C1 480000.555, C2 70000.555, C3 5000.555}, COORD {C1 480000.666, C2 70000.666, C3 5000.666}]}}}]}]}", gpkg2iox.read(rs.getBytes(1)).toString());
        }
