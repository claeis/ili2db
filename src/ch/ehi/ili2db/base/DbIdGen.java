...
public class DbIdGen {
	...
	String dbusr=null;
	public DbIdGen(java.sql.Connection conn,String dbusr)
	{
		this.conn=conn;
		this.dbusr=dbusr;
	}
...
//	);
	...
	static public void addMappingTable(ch.ehi.sqlgen.repository.DbSchema schema)
	{
	...
	public int getLastId(String key,String schema)
	{
	...
	public void setLastId(int newId,String key,String schema)
	{
		String sqlName=SQL_T_KEY_OBJECT;
		if(schema!=null){
			sqlName=schema+"."+sqlName;
