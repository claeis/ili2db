...
public class Json23Test extends ch.ehi.ili2db.Json23Test {
    ...
    private static final String DUCKDBFILENAME=TEST_OUT+"Json23.duckdb";
    ...
    protected void importXtf_doAsserts(Statement stmt) throws SQLException {
        ...
        try {
            ...
            assertTrue(rs.next());
            assertEquals("[{\"@type\":\"Json23.TestA.Farbe\",\"r\":10,\"g\":11,\"b\":12,\"name\":\"f1\",\"active\":false},{\"@type\":\"Json23.TestA.Farbe\",\"r\":20,\"g\":21,\"b\":22,\"name\":\"f2\",\"active\":false}]",rs.getString(1));
