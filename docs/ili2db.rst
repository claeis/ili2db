...
OID verwendet, wird die Funktion gen_random_uuid() verwendet.
Dazu muss für PostgreSQL VOR Version 13 die PostgreSQL-Erweiterung pgcrypto konfiguriert sein
(``CREATE EXTENSION "pgcrypto";``). Mit der Option ``--setupPgExt``
...
+-------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| --setupPgExt                  | **PostGIS:** erstellt postgreql Erweiterungen 'pgcrypto' und 'postgis' (falls noch nicht vorhanden)                                                                                                                                                                                                                                                                                                                                                                                                                                       |
+-------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
