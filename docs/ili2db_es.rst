...
la función gen\_random\_uuid() será empleada. PostgreSQL < 13: Para ello es necesario de
configurar la extensión de PostgreSQL pgcrypto (CREATE EXTENSION
"pgcrypto";).
...
+-------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| --setupPgExt                  | **PostGIS:** crea la extensión PostgreSQL 'pgcrypto' y 'postgis' (si aún no creadas).                                                                                                                                                                                                                                                                                                                                                                                                 |
+-------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
