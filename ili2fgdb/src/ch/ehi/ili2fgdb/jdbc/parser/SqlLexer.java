...
public SqlLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("DATE", this), new Integer(56));
	literals.put(new ANTLRHashString("SET", this), new Integer(22));
	literals.put(new ANTLRHashString("-", this), new Integer(38));
	literals.put(new ANTLRHashString("IS", this), new Integer(26));
	literals.put(new ANTLRHashString("VARBINARY", this), new Integer(60));
	literals.put(new ANTLRHashString("VALUES", this), new Integer(13));
	literals.put(new ANTLRHashString("CHAR", this), new Integer(45));
	literals.put(new ANTLRHashString("<", this), new Integer(33));
	literals.put(new ANTLRHashString("NULL", this), new Integer(23));
	literals.put(new ANTLRHashString("LIKE", this), new Integer(27));
	literals.put(new ANTLRHashString("EXISTS", this), new Integer(31));
	literals.put(new ANTLRHashString("SMALLINT", this), new Integer(49));
	literals.put(new ANTLRHashString("ORDER", this), new Integer(19));
	literals.put(new ANTLRHashString("WHERE", this), new Integer(6));
	literals.put(new ANTLRHashString("VARCHAR", this), new Integer(46));
	...
	literals.put(new ANTLRHashString("DESC", this), new Integer(43));
	...
	literals.put(new ANTLRHashString("DECIMAL", this), new Integer(51));
	literals.put(new ANTLRHashString(">=", this), new Integer(36));
	literals.put(new ANTLRHashString("ASC", this), new Integer(42));
	...
	literals.put(new ANTLRHashString("yyyy-mm-dd hh:mm:ss.ss", this), new Integer(61));
	literals.put(new ANTLRHashString("INTO", this), new Integer(8));
	literals.put(new ANTLRHashString("TIME", this), new Integer(57));
	literals.put(new ANTLRHashString("TIMESTAMP", this), new Integer(58));
	literals.put(new ANTLRHashString("REAL", this), new Integer(52));
	literals.put(new ANTLRHashString("DOUBLE", this), new Integer(53));
	literals.put(new ANTLRHashString("<=", this), new Integer(35));
	literals.put(new ANTLRHashString("AND", this), new Integer(18));
	literals.put(new ANTLRHashString("NOT", this), new Integer(25));
	literals.put(new ANTLRHashString("INT", this), new Integer(48));
	literals.put(new ANTLRHashString("ESCAPE", this), new Integer(28));
	literals.put(new ANTLRHashString("BETWEEN", this), new Integer(30));
	literals.put(new ANTLRHashString("PRECISION", this), new Integer(54));
	literals.put(new ANTLRHashString("INTEGER", this), new Integer(47));
	literals.put(new ANTLRHashString("BY", this), new Integer(20));
	literals.put(new ANTLRHashString("BINARY", this), new Integer(59));
