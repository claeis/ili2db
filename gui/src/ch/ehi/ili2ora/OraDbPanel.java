...
public class OraDbPanel extends JPanel {
			...
			testConnectionButton.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					try{
					  ...
					  // TODO SELECT SDO_VERSION FROM DUAL;
						try{
							String version=null;
							java.sql.Statement stmt=conn.createStatement();
							java.sql.ResultSet ret=stmt.executeQuery("SELECT SDO_VERSION FROM DUAL");
							ret.next();
							version=ret.getString("SDO_VERSION");
							EhiLogger.logState("oracle spatial version <"+version+">");
