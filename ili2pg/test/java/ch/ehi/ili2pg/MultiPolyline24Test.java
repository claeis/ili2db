...
public class MultiPolyline24Test extends ch.ehi.ili2db.MultiPolyline24Test {
    ...
    protected void assertMultiPolyline24_classa1_geomattr1(Statement stmt) throws Exception {
        ...
        while (rs.next()) {
            assertEquals("SRID=2056;MULTICURVE(COMPOUNDCURVE((480000.111 70000.111 5000.111,480000.222 70000.222 5000.222,480000.333 70000.333 5000.333)))", rs.getObject(1));
        }
    }
}
