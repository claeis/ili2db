...
CREATE TABLE MultiSurface.classa1_point (
  T_Id bigint PRIMARY KEY
  ,T_basket bigint NOT NULL
)
;
SELECT AddGeometryColumn('multisurface','classa1_point','point',(SELECT srid FROM SPATIAL_REF_SYS WHERE AUTH_NAME='EPSG' AND AUTH_SRID=21781),'POINT',2);
...
ALTER TABLE MultiSurface.classa1_point ADD CONSTRAINT classa1_point_T_Id_fkey FOREIGN KEY ( T_Id ) REFERENCES MultiSurface.classa1 DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE MultiSurface.classa1_point ADD CONSTRAINT classa1_point_T_basket_fkey FOREIGN KEY ( T_basket ) REFERENCES MultiSurface.T_ILI2DB_BASKET DEFERRABLE INITIALLY DEFERRED;
...
;
ALTER TABLE MultiSurface.T_ILI2DB_ATTRNAME ADD CONSTRAINT T_ILI2DB_ATTRNAME_Owner_SqlName_key UNIQUE (ColOwner,SqlName)
;
