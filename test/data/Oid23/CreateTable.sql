...
;
ALTER TABLE Oid23.T_ILI2DB_IMPORT_BASKET ADD CONSTRAINT T_ILI2DB_IMPORT_BASKET_import_fkey FOREIGN KEY ( importrun ) REFERENCES Oid23.T_ILI2DB_IMPORT DEFERRABLE INITIALLY DEFERRED;
...
;
ALTER TABLE Oid23.T_ILI2DB_ATTRNAME ADD CONSTRAINT T_ILI2DB_ATTRNAME_SqlName_Owner_key UNIQUE (SqlName,ColOwner)
;
