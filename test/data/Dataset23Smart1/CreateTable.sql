...
;
ALTER TABLE Dataset1smart1.T_ILI2DB_IMPORT_BASKET ADD CONSTRAINT T_ILI2DB_IMPORT_BASKET_import_fkey FOREIGN KEY ( import ) REFERENCES Dataset1smart1.T_ILI2DB_IMPORT DEFERRABLE INITIALLY DEFERRED;
...
;
ALTER TABLE Dataset1smart1.T_ILI2DB_ATTRNAME ADD CONSTRAINT T_ILI2DB_ATTRNAME_SqlName_Owner_key UNIQUE (SqlName,Owner)
;
