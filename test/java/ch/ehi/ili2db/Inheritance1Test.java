...
public class Inheritance1Test {
	private static final String INHERITANCE1_SMART = "Inheritance1_smart";
	...
	@Test
	public void importSmart() throws Ili2dbException
	{
		File data=new File("test/data/Inheritance1a.xtf");
		Config config=initConfig(data.getPath(),INHERITANCE1_SMART,data.getPath()+".log");
