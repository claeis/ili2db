    ...
    protected void assertImportXtfLine_line3(Statement stmt) throws SQLException {
        {
        	...
        	while(rs.next()){
        	    String geom=rs.getString(1);
        	    if(setup.supportsCompoundGeometry()) {
                    assertEquals("COMPOUNDCURVE Z (CIRCULARSTRING Z (2460001 1045001 300,2460005 1045004 1.#QNAN,2460006 1045006 300),(2460006 1045006 300,2460010 1045010 300))", geom);
        	    }else {
